...
exists($$PWD/src/Starter/$$PROJECT_FILTER*.cpp) {
    SOURCES += $$PWD/src/Starter/$$PROJECT_FILTER*.cpp
}
...
exists($$PWD/src/Starter/$$PROJECT_FILTER*.h) {
    HEADERS += $$PWD/src/Starter/$$PROJECT_FILTER*.h
}
...
DISTFILES += \
    res/Elections/* \
    res/Elections/Data/* \
    res/Elections/Visualizer/* \
    res/DoctorsWithoutOrders/* \
    res/DNADetective/* \
    res/DisasterPlanning/*
